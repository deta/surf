...
<div
  class="antialiased w-screen h-screen will-change-auto transform-gpu relative drag flex flex-col bg-blue-300/75"
...
-->
  ...
  >
    <div
      slot="sidebar"
      id="left-sidebar"
      class="flex-grow bg-red-500/0 {horizontalTabs ? 'w-full h-full' : 'h-full'}"
      style="z-index: 5000;"
    >
      {#if $sidebarTab !== 'oasis'}
        <div
