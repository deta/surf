...
impl LocalAIServer {
    ...
    pub fn new(
        ...
        if local_llm {
            error!("local LLM support not implemented");
            return Err(BackendError::GenericError(
                "Local LLM not supported".to_string(),
            ));
        }

        debug!("initializing remote embedding model");
    ...
    fn handle_main_thread_messages(
        ...
        debug!("initializing embeddings store");
        ...
        debug!("starting main message loop");
        loop {
