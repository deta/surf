...
const IPC_EVENTS = ipcService.registerEvents({
  ...
  setAdblockerState: ipcService.addEvent<AdblockerStateChange>(
    "set-adblocker-state",
  ),
  appReady: ipcService.addEvent<void>("app-ready"),
  downloadRequest:
    ipcService.addEvent<DownloadRequestMessage>("download-request"),
  downloadUpdated:
    ipcService.addEvent<DownloadUpdatedMessage>("download-updated"),
  ...
  updateUserConfig:
    ipcService.addEvent<Partial<UserConfig>>("store-user-config"),
  updateUserStats: ipcService.addEvent<Partial<UserStats>>("store-user-stats"),
  userConfigSettingsChange: ipcService.addEvent<UserSettings>(
    "user-config-settings-change",
  ),
  userStatsChange: ipcService.addEvent<UserStats>("user-config-stats-change"),
  updateInitializedTabs: ipcService.addEvent<boolean>(
    "update-initialized-tabs",
  ),
  ...
  updatePrompt:
    ipcService.addEvent<Pick<EditablePrompt, "id" | "content">>(
      "update-prompt",
    ),
  ...
  browserFocusChange: ipcService.addEvent<BrowserFocusChange>(
    "browser-focus-change",
  ),
  adBlockerStateChange: ipcService.addEvent<AdblockerStateChange>(
    "adblocker-state-change",
  ),
  ...
  toggleRightSidebarTab: ipcService.addEvent<RightSidebarTab>(
  ...
  openSettings: ipcService.addEvent<SettingsWindowTab | undefined>(
    "open-settings",
  ),
  openResourceLocally: ipcService.addEvent<SFFSResource>(
    "open-resource-locally",
  ),
  ...
  importBrowserHistory: ipcService.addEvent<BrowserType>(
    "import-browser-history",
  ),
  importBrowserBookmarks: ipcService.addEvent<BrowserType>(
    "import-browser-bookmarks",
  ),
  setSurfBackendHealth: ipcService.addEvent<boolean>("set-surf-backend-health"),
  setActiveTabWebContentsId: ipcService.addEvent<number>(
    "set-active-tab-webcontents-id",
  ),
  closeTabWebContentsId: ipcService.addEvent<number>(
    "close-tab-webcontents-id",
  ),
  ...
  setExtensionMode: ipcService.addEvent<"horizontal" | "vertical">(
    "set-extension-mode",
  ),
  extensionModeChange: ipcService.addEvent<ExtensionModeChange>(
    "extension-mode-change",
  ),
  ...
  webContentsViewEvent: ipcService.addEvent<WebContentsViewEvent>(
    "webcontentsview-event",
  ),

  // events that return a value
  getAdblockerState: ipcService.addEventWithReturn<GetAdblockerState>(
    "get-adblocker-state",
  ),
  captureWebContents: ipcService.addEventWithReturn<CaptureWebContents>(
    "capture-web-contents",
  ),
  getUserConfig:
    ipcService.addEventWithReturn<GetUserConfig>("get-user-config"),
  ...
  interceptRequestHeaders:
    ipcService.addEventWithReturn<InterceptRequestHeaders>(
      "intercept-request-headers",
    ),
  screenshotPage:
    ipcService.addEventWithReturn<ScreenshotPage>("screenshot-page"),
  getExtensionMode:
    ipcService.addEventWithReturn<GetExtensionMode>("get-extension-mode"),
  tokenCreate: ipcService.addEventWithReturn<TokenCreate>("token-create"),
  webviewReadResourceData:
    ipcService.addEventWithReturn<WebviewReadResourceData>(
      "webview-read-resource-data",
    ),
  isDefaultBrowser:
    ipcService.addEventWithReturn<DefaultBrowserCheck>("is-default-browser"),
  getAnnouncements:
    ipcService.addEventWithReturn<GetAnnouncements>("get-announcements"),
  getExtensionsEnabled: ipcService.addEventWithReturn<GetExtensionsEnabled>(
    "get-extensions-enabled",
  ),
  listExtensions:
    ipcService.addEventWithReturn<ListExtensions>("list-extensions"),

  // WebContentsView events
  webContentsViewManagerAction:
    ipcService.addEventWithReturn<WebContentsViewManagerActionEvent>(
      "webcontentsview-manager-action",
    ),
  webContentsViewAction:
    ipcService.addEventWithReturn<WebContentsViewActionEvent>(
      "webcontentsview-action",
    ),
});
